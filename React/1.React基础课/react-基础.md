...
| 清除搜索功能 | 清空搜索参数  重新获取列表           |
 ...
 ![image-20220423133044637](react-基础.assets/image-20220423133044637.png)

# 补充

- `useContext`查找机制：useContext优先从Provider value找传递的数据，如果找不到，就会找createContext方法传递过来的默认参数

- ```js
  //模块化统一管理store(context依赖z)
